    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='kgl_app.branch')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.FloatField(default=2)),
                ('amount_due', models.FloatField(default=2)),
                ...
                ('branch', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='kgl_app.branch')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
